...
export default function PrivacyPage() {
    return (
        <main className="privacy text-color-primary ">
        <h1>プライバシーポリシー</h1>

        <div>
        myohmai（以下、「運営者」といいます。）は、本ウェブサイト上で提供するサービス「Tangled To」（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
        </div>
        <h2>第1条（個人情報）</h2>
        <div>
        ...
        <h2> 第2条（個人情報の収集方法）</h2>
        <div>
        運営者は、ユーザーが利用登録をする際に氏名またはニックネーム、生年月日、メールアドレスなどの個人情報をお尋ねすることがあります。また、本サービスの利用に伴い、ユーザーが投稿したコンテンツ、利用履歴、ログ情報、デバイス情報等を収集することがあります。なお、有料サービスの提供にあたっては、決済に必要な情報をお尋ねすることがあります。
        </div>
