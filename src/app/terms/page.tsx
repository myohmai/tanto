...
export default function Page() {
    return (
        <main className="terms">
            <h1>利用規約</h1>
                <div>
                この利用規約（以下、「本規約」といいます。）は、myohmai（以下、「運営者」といいます。）がこのウェブサイト上で提供するサービス「Tangled To」（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
                </div>
                <h2> 第1条（適用）</h2>
                <ul>
                ...
                <h2> **第4条（利用資格）**</h2>
                <div>
                本サービスは、13歳以上の方を対象としています。13歳未満の方は本サービスを利用することができません。18歳未満の方が本サービスを利用する場合には、保護者の同意を得た上でご利用ください。
                </div>
