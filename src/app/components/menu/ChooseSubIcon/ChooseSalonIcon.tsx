...
type Props = {
    onSubmit: (icon: SalonIcon)=> void;
    isOpen: boolean;
    onClose: () => void;
}

export const ChooseSalonIcon = ({ onSubmit, isOpen, onClose }: Props ) => {
    const [selectedSubIcon, setSelectedSubIcon] = useState<SalonIcon | null>(null)
    const [emojiValue, setEmojiValue] = useState('')
    const [emojiError, setEmojiError] = useState('')
    return(
        <BottomSheet isOpen={isOpen} onClose={onClose} contentClassName='choose-sub-icon stack-lg' >
            <div className='choose-sub-icon__title'>Choose a color or emoji for salon icon</div>
